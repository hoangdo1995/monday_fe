...
const CompleteProfileStep = () => {
  ...
  const updateCompleteStep = (currentStep, state) => {
    ...
    if (targetInput) targetInput.defaultChecked = state;
    setStepComplete(
      document.querySelectorAll('input[name="profile-step-check"]:checked')
        .length
    );
  };
  ...
  useEffect(() => {
    ...
    const listStepProfileInput =
      document.querySelectorAll("label.profile-step");
  ...
  return (
    <div>
      <div className="break-line-bottom px-6 py-3">
        ...
        <label className="profile-step flex items-center">
          <input
            name="profile-step-check"
            value="setup-account-step"
            className="hidden"
            type="checkbox"
          ></input>
        ...
        <label
          className="profile-step flex items-center"
          onClick={() => setUploadAvatarPhotoOpen(true)}
        >
          <input
            name="profile-step-check"
            value="upload-photo-step"
            className="hidden"
            type="checkbox"
          ></input>
          <span className="checkbox-box">
        ...
        <label
          className="profile-step flex items-center"
          onClick={() => {
            showEnableShowNotification();
          }}
        >
          <input
            name="profile-step-check"
            value="enable-notification-step"
            className="hidden"
            type="checkbox"
          ></input>
          <span className="checkbox-box">
        ...
        {/* upload photo modal */}
        <Modal
          wrapClassName="profile-step-modal"
          centered
          footer={null}
          open={uploadAvatarPhotoOpen}
          onOk={() => setUploadAvatarPhotoOpen(false)}
          onCancel={() => {
            setUploadAvatarPhotoOpen(false);
            updateCompleteStep("upload-photo-step", false);
          }}
        ...
        >
          <div className="text-center border-t-4 border-t-sky-400 py-5">
            <div>
              <span className="gray-text text-3xl font-light mt-4 mb-2">
                Upload a profile picture
              </span>
              <span className="gray-text text-base block">
                Pictures make it easier to collaborate
              </span>
            </div>
            <div className="flex justify-center flex-col items-center pb-7">
              <div
                className="avatar text-6xl font-bold text-white content-center bg-green-400 rounded-full mt-7"
              ...
              <div>
                <ImgCrop>
                  <Upload
                    ...
                    onChange={onChangeImageChoose}
                  >
                    <button className="bg-blue-600 text-white py-1 mt-3 px-2 rounded">
        ...
        >
          <div className="py-5 px-5">
            <div className="">
              <h5 className="text-3xl font-normal mb-5 mt-2">
                Invite to work management
              </h5>
              <div>
                <form action="">
                  ...
                  <div className="flex mt-6 text-sm">
                    <RadioInputMain
                      title={"Member"}
                      customStyle={{ marginRight: 30, fontSize: 15 }}
                      value={"member"}
                      name={"type-user"}
                      checkedDefault={true}
                      onChange={() => {}}
                    ...
                    />
                    <div
                      className="rounded  px-2 py-1 ms-2"
                      style={{ backgroundColor: "#133774" }}
                    >
                      Free
                    </div>
                  </div>
                  <div className="text-end mt-24">
                    <button className="button-main !px-4 text-base text-white font-light">
                      Invite
                    </button>
                  </div>
                </form>
        ...
        >
          <form className="border-t-4 border-sky-500" style={{ minWidth: 600 }}>
            <div className="px-5 py-5">
              <span className="gray-text text-2xl block mb-5">
                Complete your profile
              </span>
              <div>
            ...
            <div>
              <button
                className="bg-blue-600 hover:bg-blue-800 w-full py-2 text-xl font-bold"
                type="submit"
                onClick={(event) => {
                  event.preventDefault();
                  updateCompleteStep("complete-profile-step", true);
                  setProfileOpen(false);
                }}
              >
                Save
        ...
        <Modal
          ...
          footer={null}
          open={installAppOpen}
          onOk={() => setInstallAppOpen(false)}
          onCancel={() => {
            setInstallAppOpen(false);
            updateCompleteStep("install-app-step", false);
          }}
          closeIcon={<ModalCloseButton />}
          destroyOnClose={true}
        >
          <div className="py-20">
            <div className="flex justify-between">
              <div
                className="flex flex-col justify-center items-center text-center px-14"
                style={{ maxWidth: 500 }}
              >
                ...
                <div className="text-base my-8">
                  Get work done from anywhere, no signup needed
                </div>
                <div className="rounded-2xl bg-white p-1">
                  <img
                    src="/images/png/app_install_QR.png"
                    style={{ width: 170 }}
                    alt=""
                  />
                </div>
                <div className="text-base my-3">Or</div>
                <div className="text-base">
                  <Link className="text-blue-500" to={""}>
                    Email me the dowload links
                  </Link>
                </div>
              </div>
              <div className="h-fit">
                <img
                  ...
                  src="./images/png/download-mobile-app-dark-v3.png"
                  alt=""
                />
              </div>
            </div>

...
const AddMemberInput = () => {
    ...
    return (
        <div className="flex my-2">
            <input className="add-member-email max-w-full border border-r-0 outline-none rounded-l-md border-gray-400 py-1 px-2 w-3/5 focus:border-sky-400 focus:border-e"  type="email" placeholder="Add email here" style={{minWidth:250}}/>

...
const ItemSelect = (props) => {
  ...
  return <div className="item-select inline-block animate__animated animate__bounceIn me-7 mb-5" onClick={(event)=>event.currentTarget.classList.toggle('animate__bounceIn')}>
